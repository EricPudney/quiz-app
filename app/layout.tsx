...
export const metadata: Metadata = {
  ...
  description: "An app to help you create quizzes",
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="An app for quizmasters" />
        ...
        <meta property="og:description" content="An app for quizmasters" />
